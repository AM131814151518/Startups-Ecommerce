...
const Product = () => {
  ...
  if (loading) return <h1>loading plz wiat</h1>;
    ...
    data.product.data.attributes;
  {
    ...
    image.map(({attributes})=>{
      return <img src={BACKEND_URL+attributes.url}/>
    })
  }*/
  }
          ...
          <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
            ...
            <div className=" flex flex-row justify-between  mt-5">
              <div className=" flex flex-row space-x-3">
                <svg
                  className="cursor-pointer -[#FFBF1B]"
                  width="20"
                  height="21"
                  viewBox="0 0 20 21"
                  fill="none"
...
<div className="my-3">
            <button className="bg-[#FFBF1B]  hover:bg-[#e4a914]  text-white font-bold py-2 px-4 rounded"  onClick={minusCount}>-</button>
 <span className="font-bold py-2 px-4 rounded focus:ring-[#FFBF1B]">{count}</span>
<button className="bg-[#FFBF1B]  hover:bg-[#e4a914] text-white font-bold py-2 px-4 rounded" onClick={addCount}>+</button>
</div>
  ...
  <div>
            <button onClick={addToCart} className="focus:outline-none focus:ring-2 hover:bg-[#e4a914]  focus:ring-offset-2 rounded-full duration-500 focus:ring-[#FFBF1B] font-medium text-base leading-4 text-white bg-[#FFBF1B] w-full py-5 lg:mt-12 mt-6">
              Add to shopping bag
            </button>
            </div>
          </div>
          ...
          <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
            <div className=" w-full lg:w-auto bg-gray-100 flex justify-center items-center rounded-md">
              <img
                src={
                  BACKEND_URL +
                  data.product.data.attributes.image.data.attributes.url
        ...
        <div className="flex  justify-center items-center w-full">
          <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
            <div>
              <span className="text-[#FFBF1B] text-6xl">
              <TbToolsKitchen />
              </span>
              <p className="font-semibold text-xl leading-5 text-[#E50914] lg:mt-10 mt-9">
                Ready To Cook
              </p>
              <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                Our Frozen Food is ready to cook!{" "}
              </p>
            </div>
            <div>
              <span className="text-6xl text-[#FFBF1B]">
            <MdOutlineMedicalServices />
              ...
              <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                All our products are super health friendly.{" "}
              </p>
            </div>
            <div>
            <span className="text-6xl text-[#FFBF1B]">
